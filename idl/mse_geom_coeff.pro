;------------------------------------------------------------------------------
; Procedure: mse_geom_coeff
;
; Created: 10-4-96   B. Rice
;
; Modified:
;
;   99/12/7 - MAM - added coding for half energy channels
;   03/12/9 - MAM - This routine has been replaced by mse_geom_coeff2. It's
;                   geometry data is valid for calibration up to and including
;                   2002. See the new version of the routine for calibrations
;                   in 2003 and beyond.
;
;------------------------------------------------------------------------------
; Calling format:  
...
function mse_geom_coeff, R, z, L, view, source, energy
...
; Beam geometry data
  ...
  xcp = 1.2926           ; x position of right-left beam crossover point
  ycp = 2.3935           ; y "     "
