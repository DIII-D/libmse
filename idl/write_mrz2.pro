...
pro write_mrz2, dum
  ...
  ; Call mse_geom_coeff3, print a table of numbers for inspection, and write the mrz-file

  mg = mse_geom_coeff3( R[0:n_chan-1], z[0:n_chan-1], L[0:n_chan-1], view[0:n_chan-1],        $
